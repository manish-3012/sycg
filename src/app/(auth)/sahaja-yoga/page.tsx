...
export default function AboutSahajaYogaPage() {
  return (
    <div className="container mx-auto lg:px-40 sm:px-4 py-8">
      <h1 className="text-4xl text-green-700 font-bold text-center mb-8">About Sahaja Yoga</h1>

      <section className="flex flex-col md:flex-row items-center mb-7">
        <div className="md:w-1/2 mx-4">
          <h2 className="text-2xl text-green-50 font-semibold mb-4">What is Sahaja Yoga?</h2>
      ...
      <section className="flex flex-col md:flex-row items-center mb-12">
        <div className="md:w-1/2 mx-4">
          <h2 className="text-2xl font-semibold text-green-50 mb-4">What are the origins of Sahaja Yoga?</h2>
          <p className="mb-4 text-gray-50 text-justify">
      ...
      <section className="flex mx-4 flex-col md:flex-row-reverse items-center mb-12 bg-green-600 p-6 rounded-lg">
        <div className="md:w-1/2 ">
      ...
      <section className="flex flex-col md:flex-row items-center mb-12">
        <div className="md:w-1/2 mx-4">
          <h2 className="text-2xl font-semibold text-green-50 mb-4">Who can benefit from Sahaja Yoga?</h2>
          <p className="mb-4 text-gray-50 text-justify">
