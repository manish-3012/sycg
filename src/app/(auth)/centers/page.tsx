...
const CentersTable: React.FC = () => {
  ...
  return (
    <div className="overflow-x-auto mx-4 lg:mx-6">
      <h1 className="text-4xl text-green-600 font-bold text-center mb-8">Do Visit Us 😇</h1>
          ...
          <table className="min-w-full border-collapse">
            ...
            <tbody>
              {centers.map((center, index) => (
                <tr key={center._id} className={index % 2 === 0 ? 'bg-white text-gray-50 regular' : 'bg-green-600 text-white'}>
      ...
      <div className="mt-8 text-center">
        <p className="text-2xl font-bold text-green-600 mb-4">IT'S ALWAYS FREE!</p>
        <p className="text-lg">
